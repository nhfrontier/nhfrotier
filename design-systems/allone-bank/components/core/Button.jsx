...
function Spinner(){
  return <span aria-hidden style={{width:16,height:16,borderRadius:'50%',border:'2px solid currentColor',borderTopColor:'transparent',opacity:.7,animation:'allone-spin 700ms linear infinite'}}/>;
}
