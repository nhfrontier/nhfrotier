...
function Spinner() {
  return /*#__PURE__*/React.createElement("span", {
    ...
    style: {
      ...
      opacity: .7,
      animation: 'allone-spin 700ms linear infinite'
    }
  });
}
...
function Icon({
  ...
  return /*#__PURE__*/React.createElement("i", _extends({
    "aria-hidden": true,
    className: 'allone-icon icon-' + name,
    style: {
      fontSize: size,
      width: size,
      height: size,
...
function Sheet({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      animation: 'allone-fade var(--dur-base) var(--ease-standard)'
    }
    ...
    style: {
      ...
      maxHeight: '86%',
      overflow: 'auto',
      animation: 'allone-sheet-in var(--dur-sheet) var(--ease-decel)',
      ...style
    }
...
function Toast({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    style: {
      ...
      animation: 'allone-toast-in var(--dur-base) var(--ease-decel)',
      ...TONES[tone],
      ...style
    }
...
function PinDots({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    style: {
      ...
      gap: 'var(--sp-10)',
      justifyContent: 'center',
      animation: error ? 'allone-shake 320ms var(--ease-standard)' : 'none',
      ...style
    }
  }, rest), Array.from({
    length
...
function AllMenuScreen({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: big ? 'allone-bigtext' : undefined,
    style: {
      flex: 1,
      minHeight: 0,
      display: 'flex',
